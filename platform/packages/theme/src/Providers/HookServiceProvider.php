            ...
            ->setSection([
                ...
                'fields' => [
                    ...
                    [
                        'id' => 'mobile_logo',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_mobile_logo'),
                        'attributes' => [
                            'name' => 'mobile_logo',
                            'value' => null,
                            'attributes' => ['allow_thumb' => false],
                    ...
                    [
                        'id' => 'icon_video',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_video'),
                        'attributes' => [
                            'name' => 'icon_video',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_size',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_size'),
                        'attributes' => [
                            'name' => 'icon_size',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_color',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_color'),
                        'attributes' => [
                            'name' => 'icon_color',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_zalo',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_zalo'),
                        'attributes' => [
                            'name' => 'icon_zalo',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_messenger',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_messenger'),
                        'attributes' => [
                            'name' => 'icon_messenger',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_phone',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_phone'),
                        'attributes' => [
                            'name' => 'icon_phone',
                            'value' => null,
                        ],
                    ...
                    [
                        'id' => 'icon_quote',
                        'type' => 'mediaImage',
                        'label' => trans('packages/theme::theme.theme_option_quote'),
                        'attributes' => [
                            'name' => 'icon_quote',
                            'value' => null,
                        ],

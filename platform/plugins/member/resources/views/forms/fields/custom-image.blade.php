            ...
            @if ($showField)
                <div class="image-box">
                    ...
                    <div class="preview-image-wrapper">
                        <img src="{{ RvMedia::getImageUrl($options['value'], 'thumb', false, RvMedia::getDefaultImage()) }}" alt="{{ trans('core/base::base.preview_image') }}" class="preview_image" width="150" height="150">

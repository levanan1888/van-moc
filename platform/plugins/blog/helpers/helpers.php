...
if (!function_exists('get_trees_categories')) {
    /**
     * @param array $args
     * @return array
     */
    function get_trees_categories($categories, int $parent_id = 0): array
    {
        $categoryTree = [];
        if (!empty($categories)) {
            foreach ($categories as $category) {
...
if (!function_exists('get_children_category_ids')) {
    /**
     * @param array $args
     * @return array
     */
    function get_children_category_ids($category): array
    {
        $categoryIds = [];

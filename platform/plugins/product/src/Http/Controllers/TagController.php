...
use Botble\Product\Forms\TagForm;
use Botble\Product\Http\Requests\TagRequest;
use Botble\Product\Repositories\Interfaces\TagInterface;
use Botble\Product\Tables\TagTable;
use Exception;
...
class TagController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/product::tags.menu'));
    ...
    {
        page_title()->setTitle(trans('plugins/product::tags.create'));
    ...
    public function store(TagRequest $request, BaseHttpResponse $response)
    {
        ...
        event(new CreatedContentEvent(PTAG_MODULE_SCREEN_NAME, $request, $tag));

        return $response
            ->setPreviousUrl(route('ptags.index'))
            ->setNextUrl(route('ptags.edit', $tag->id))
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/product::tags.edit') . ' "' . $tag->name . '"');
    ...
    public function update($id, TagRequest $request, BaseHttpResponse $response)
    {
        ...
        event(new UpdatedContentEvent(PTAG_MODULE_SCREEN_NAME, $request, $tag));
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            event(new DeletedContentEvent(PTAG_MODULE_SCREEN_NAME, $request, $tag));
    ...
    {
        return $this->executeDeleteItems($request, $response, $this->tagRepository, PTAG_MODULE_SCREEN_NAME);
    }
